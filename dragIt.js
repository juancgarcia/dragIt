 ...
 * dragIt.js
 *
 * Aurthor: JuanCGarcia <JuanGarcia.info@gmail.com>
 * url: http://github.com/juancgarcia/dragIt
 *
...
(function( $ ) {
  $.widget( "ui.dragIt", $.ui.mouse, {
    ...
    _mouseStart: function(event){
        this.element.blur();
        if(window.log && this.options.debug)log('input - draggy', this.element[0].id + ' ' + event.type);
    ...
    _mouseDrag: function(event){
        ...
        this._dragging = true;
        if(window.log && this.options.debug)log('input - draggy', this.element[0].id + ' ' + event.type, 'x: '+this._entry.x, 'y: '+this._entry.y, 'dx: '+dx, 'dy: '+dy);
    ...
    _mouseStop: function(event){
        if(window.log && this.options.debug)log('input - draggy', this.element[0].id + ' ' + event.type, 'x: '+ this._entry.x, 'y: '+ this._entry.y );
